...
class Player(pygame.sprite.Sprite):
    ...
    def move(self, speed):
        # normalize diagonal movement, which would otherwise be
        # slightly faster than left,right,up,down movement
    ...
    def collision(self, direction):
        if direction == 'horizontal':
            for sprite in self.obstacle_sprites:
                # if the rectangle of sprite collides with rectangle of player
